...
namespace MSIL
{
	...
	public class IL_conv_ovf_u8_un : Instruction 
	{
		...
		public IL_conv_ovf_u8_un(MethodDefinition parentMethod, Cecil.Cil.Instruction cecilInstruction) 
		...
		{
			throw new Exception("M6x09_Simulate [conv.ovf.u8.un] not done!");
		}
