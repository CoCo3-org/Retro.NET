...
namespace MSIL
{
	public class MethodDefinition 
	{
		...
		public void InitCecilLocalVariables() 
		{
			for (int x = 0; x < this.CecilMethodDefinition.Body.Variables.Count; x++)
				this.LocalVariables.Add(null);
		}

		public void InitCecilInstructions() 
		{
			int count = 0;
		...
		protected Instruction CIL_BuildInstruction(Cecil.Cil.Instruction instruction) 
		{
			...
			switch (instruction.OpCode.Code)
			{
				...
				case Cecil.Cil.Code.Bge_Un_S:
					op = new IL_bge_un_s(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Bgt_Un_S:
					op = new IL_bgt_un_s(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Ble_Un_S:
					op = new IL_ble_un_s(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Isinst:
					op = new IL_isinst(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Conv_R_Un:
					op = new IL_conv_r_un(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Conv_Ovf_I1_Un:
					op = new IL_conv_ovf_i1_un(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Conv_Ovf_I2_Un:
					op = new IL_conv_ovf_i2_un(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Conv_Ovf_I4_Un:
					op = new IL_conv_ovf_i4_un(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Conv_Ovf_I8_Un:
					op = new IL_conv_ovf_i8_un(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Conv_Ovf_U1_Un:
					op = new IL_conv_ovf_u1_un(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Conv_Ovf_U2_Un:
					op = new IL_conv_ovf_u2_un(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Conv_Ovf_U4_Un:
					op = new IL_conv_ovf_u4_un(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Conv_Ovf_U8_Un:
					op = new IL_conv_ovf_u8_un(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Conv_Ovf_I_Un:
					op = new IL_conv_ovf_i_un(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Ldlen:
					op = new IL_ldlen(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Ldelema:
					op = new IL_ldelema(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Ldelem_I1:
					op = new IL_ldelem_i1(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Ldelem_U1:
					op = new IL_ldelem_u1(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Ldelem_I2:
					op = new IL_ldelem_i2(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Ldelem_U2:
					op = new IL_ldelem_u2(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Ldelem_I4:
					op = new IL_ldelem_i4(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Ldelem_U4:
					op = new IL_ldelem_u4(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Ldelem_I8:
					op = new IL_ldelem_i8(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Ldelem_I:
					op = new IL_ldelem_i(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Ldelem_R4:
					op = new IL_ldelem_r4(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Ldelem_R8:
					op = new IL_ldelem_r8(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Ldelem_Ref:
					op = new IL_ldelem_ref(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Stelem_I:
					op = new IL_stelem_i(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Stelem_I1:
					op = new IL_stelem_i1(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Stelem_I2:
					op = new IL_stelem_i2(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Stelem_I4:
					op = new IL_stelem_i4(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Stelem_I8:
					op = new IL_stelem_i8(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Stelem_R4:
					op = new IL_stelem_r4(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Stelem_R8:
					op = new IL_stelem_r8(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Stelem_Any:
					op = new IL_stelem(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Unbox_Any:
					op = new IL_unbox_any(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Conv_Ovf_I1:
					op = new IL_conv_ovf_i1(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Conv_Ovf_U1:
					op = new IL_conv_ovf_u1(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Conv_Ovf_I2:
					op = new IL_conv_ovf_i2(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Conv_Ovf_U2:
					op = new IL_conv_ovf_u2(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Conv_Ovf_I4:
					op = new IL_conv_ovf_i4(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Conv_Ovf_U4:
					op = new IL_conv_ovf_u4(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Conv_Ovf_I8:
					op = new IL_conv_ovf_i8(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Conv_Ovf_I:
					op = new IL_conv_ovf_i(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Mul_Ovf:
					op = new IL_mul_ovf(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Mul_Ovf_Un:
					op = new IL_mul_ovf_un(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Sub_Ovf:
					op = new IL_sub_ovf(this, instruction);
					break;
				...
				case Cecil.Cil.Code.Readonly:
					op = new IL_readonly_(this, instruction);
					break;
